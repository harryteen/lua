...
*/
#define ol_MODULE_SUFFIX "@ol_MODULE_SUFFIX@"
#define ol_DIR	"@ol_DIR@"
#define ol_LDIR	"@ol_LDIR@"
#define ol_CDIR	"@ol_CDIR@"

#define ol_PATH_DEFAULT "@ol_PATH_DEFAULT@"
#define ol_CPATH_DEFAULT "@ol_CPATH_DEFAULT@"
...
*/
#define ol_PROMPT		"@ol_PROMPT@"
#define ol_PROMPT2	"@ol_PROMPT2@"
...
*/
#define ol_MAXINPUT	@ol_MAXINPUT@
